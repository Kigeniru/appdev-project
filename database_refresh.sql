...
-- MySQL compatibility: add columns only if missing using prepared statements
...
VALUES
  (1, 'Oreo Cheesecake - Oven-Baked', 'Delicious creamy cheesecake with crushed Oreo cookies, baked to perfection in the oven', 'Oven-Baked', 'piece', '899.00', 'assets/products/oreo-oven-baked.png'),
  (2, 'Biscoff Cheesecake - Oven-Baked', 'Rich and creamy cheesecake with Biscoff cookie butter, oven-baked for a perfect texture', 'Oven-Baked', 'piece', '999.00', 'assets/products/biscoff-oven-baked.png'),
  (3, 'Blueberry Cheesecake - Oven-Baked', 'Classic New York-style cheesecake with fresh blueberries, perfectly baked in the oven with a smooth and creamy texture', 'Oven-Baked', 'piece', '799.00', 'assets/products/blueberry-oven-baked.png'),
  (4, 'Oreo Cheesecake - No-Bake', 'Creamy no-bake cheesecake with crushed Oreo cookies, chilled to perfection without baking', 'No-Bake', 'piece', '849.00', 'assets/products/oreo-no-bake.png'),
  (5, 'Biscoff Cheesecake - No-Bake', 'Delicious no-bake cheesecake with Biscoff cookie butter, chilled and ready to enjoy', 'No-Bake', 'piece', '949.00', 'assets/products/biscoff-no-bake.png'),
  (6, 'Blueberry Cheesecake - No-Bake', 'Classic no-bake cheesecake with fresh blueberries, perfectly chilled with a smooth and creamy texture', 'No-Bake', 'piece', '749.00', 'assets/products/blueberry-no-bake.png');
